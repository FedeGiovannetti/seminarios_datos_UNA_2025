...
En este repositorio estarán almacenados los materiales del ciclo de seminarios sobre gestión de proyectos de investigación y gestión de datos realizados en la [Unidad de Neurobiología Aplicada (UNA, CEMIC-CONICET)](https://cemic.edu.ar/una.php) en noviembre y diciembre de 2025.

El ciclo tendrá 3 encuentros:

## 1. Gestión de proyectos de investigación reproducibles:
Este sería un primer encuentro híbrido con modalidad de presentación y taller en donde podamos poner en común la forma en que cada quien viene trabajando, y compartir algunos criterios básicos para mejorar algo de eso a partir de criterios transparencia y reproducibilidad. Este sería un encuentro híbrido.

#### 1.1. Contenidos:
Marco general de reproducibilidad y ciencia abierta en investigación psicológica. Posibles flujos de trabajo en proyectos de investigación abiertos y reproducibles. Criterios generales para la gestión de proyectos de investigación. Criterios para la organización de datos de investigación. Gestión de datos abiertos encontrables, accesibles, interoperables y reusables (FAIR principles).
